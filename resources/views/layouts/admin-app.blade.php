...
>
  <head>
    ...
    <title>HulkApps {{Auth::user()->role}}</title>
  ...
  <body>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{asset('images/dummy-profile-pic.png')}}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="#" target="_blank" class="footer-link fw-bolder">HulkApps</a>
                </div>
                <div>
                  <a href="#" class="footer-link me-4" >Versions--1.0.1</a>
   ...
   <script src="{{ asset('js/datatable-basic.js') }}"></script
    ...
    <script src="{{ URL::asset('js/custom.js') }}?v=<?php echo time() ?>"></script>

    <!-- Place this tag in your head or just before your close body tag. -->
    <script async defer src="https://buttons.github.io/buttons.js"></script>
    <script src="{{ URL::asset('js/flatpickr.min.js') }}?v=<?php echo time() ?>" type="text/javascript"></script>
